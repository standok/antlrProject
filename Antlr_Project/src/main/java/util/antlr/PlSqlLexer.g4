...
TEMP_TABLE                     : '#'[a-zA-Z_0-9ㄱ-ㅎ가-힣]*;			// 2023.12.14 LEEKIJONG
ADWOWN_TABLE                   : 'ADWOWN.'[A-Z_0-9]*;				// 2023.11.17 ADWOWN LEEKIJONG
SUM_USER                       : 'SUM('[a-zA-Z_0-9ㄱ-ㅎ가-힣]*')';	
TRIM_USER                      : 'TRIM('[a-zA-Z_0-9ㄱ-ㅎ가-힣]*')';	// 2023.12.15 TRIM LEEKIJONG
LTRIM_USER                     : 'LTRIM('[a-zA-Z_0-9ㄱ-ㅎ가-힣]*')';	// 2023.12.15 TRIM LEEKIJONG
RTRIM_USER                     : 'RTRIM('[a-zA-Z_0-9ㄱ-ㅎ가-힣]*')';	// 2023.12.15 TRIM LEEKIJONG
